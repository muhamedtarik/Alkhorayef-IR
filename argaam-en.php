<?php
/**
 * Template Name: Argaam English
 * This template file is used for Argaam Investor Relation pages (English).
 *
 * @package Avada
...
<head>
    ...
    <link rel="stylesheet" href="css/style-en/all.min.css">
    <link rel="stylesheet" href="css/style-en/pignose.calendar.min.css">
    <link rel="stylesheet" href="css/style-en/style.css">
    <script src="https://code.highcharts.com/stock/highstock.js"></script>
    <script src="https://code.highcharts.com/stock/modules/data.js"></script>
    <script src="https://code.highcharts.com/stock/modules/exporting.js"></script>
    <script src="https://cdn.jsdelivr.net/npm/vue/dist/vue.min.js"></script>
       <!-- Global site tag (gtag.js) - Google Analytics -->
   <script async src="https://www.googletagmanager.com/gtag/js?id=UA-222494071-1"></script>
    <script>
      window.dataLayer = window.dataLayer || [];
      function gtag(){dataLayer.push(arguments);}
      gtag('js', new Date());

      gtag('config', 'UA-222494071-1');
    </script>
...
<body>
    <div id="alkhorayefapp" lang="Language = 'en'">
        ...
        <main>
            ...
            <div class="sticky-header noprint">
                    ...
                    <div class="nav-container">
                        <div class="nav-container__desktop">
                            <a class="nav-container__desktop__logo" href="https://awpt.com.sa">
                                <img class="nav-container__desktop__logo__img"
                                    src="assets/logo2.png">
                            </a>
                          <div class="nav-container__desktop__links">
                                <a class="nav-container__desktop__links__link"
                                    href="https://awpt.com.sa/our-company">Our Company</a>
                                <a class="nav-container__desktop__links__link"
                                    href="https://awpt.com.sa/business-units">Business Units</a>
                                <a class="nav-container__desktop__links__link"
                                    href="https://awpt.com.sa/projects">Projects</a>
                                <a class="nav-container__desktop__links__link"
                                    href="https://awpt.com.sa/our-network">Our Network</a>
                                <a class="nav-container__desktop__links__link active" href="#">Investors</a>
                                <a class="nav-container__desktop__links__link" href="https://awpt.com.sa/reach-us">
                                    Reach
                                    Us
                                </a>
                                 <a class="nav-container__desktop__links__link" href="investor-relations-ar">عربي</a>
                            </div>
                        ...
                        <div class="nav-container__mobile">
                            ...
                            <div class="nav-container__mobile__body">
                                <a class="nav-container__mobile__body__link" href="https://awpt.com.sa/our-company">
                                    Our
                                    Company
                                </a>
                                ...
                                <a class="nav-container__mobile__body__link"
                                    href="https://awpt.com.sa/projects">Projects</a>
                                <a class="nav-container__mobile__body__link" href="https://awpt.com.sa/our-network">
                                    Our
                                    Network
                                </a>
                                <a class="nav-container__mobile__body__link active" href="#">Investors</a>
                                <a class="nav-container__mobile__body__link" href="https://awpt.com.sa/reach-us">
                                    Reach
                                    Us
                                </a>
                            </div>
                ...
                <p class="sticky-header__description">
                    In accordance with the main and subsidiary Commercial Registrations, the Company activities consist
                    of the following: Extension and maintenance of water lines between and within cities and
                    construction of new networks, construction and repair of stations and main lines of water
                    distribution, construction and repair of irrigation and watering canals, main water storage towers,
                    drilling water wells... <span
                        class="sticky-header__description__more sticky-header__description__more-en"
                        v-on:click="LoadPage('profile', loadCompanyProfile)">Read More</span>
                </p>
                <ul class="tabs sticky-header__tabs noprint">
                    ...
                    <li data-cont=".profile" v-on:click="LoadPage('profile', loadCompanyProfile)">Profile</li>
                    <li data-cont=".Chart" v-on:click="LoadPage('Chart', loadCompanyChart)">Chart</li>
                    ...
                    <li data-cont=".Major-Shareholder"
                        v-on:click="LoadPage('Major-Shareholder', loadMajorShareholders)">Major <br> Shareholder</li>
                    <li data-cont=".Financial-Statment"
                        v-on:click="LoadPage('Financial-Statment', loadCompanyFStatements)">
                    ...
                    <li data-cont=".Corporate-Actions" v-on:click="LoadPage('Corporate-Actions', loadCorporateActions)">
                        Corporate <br> Actions
                    </li>
                    <li data-cont=".main-Disclosures" v-on:click="openNews('pr__disclosures',0)">Disclosures</li>
                    <li data-cont=".subscription" v-on:click="LoadPage('subscription', loadSubscription)">Subscription
                        <br> Centre
                    </li>
                    <li data-cont=".contact-page">Contact IR</li>
                ...
                <div class="overlay-container">
                    <div class="overlay-inner">
                        ...
                        <ul class="tabs drop-down">
                            ...
                            <li data-cont=".Major-Shareholder"
                                v-on:click="LoadPage('Major-Shareholder', loadMajorShareholders)">
                                Major <br> Shareholder
                            </li>
                            <li data-cont=".Financial-Statment"
                                v-on:click="LoadPage('Financial-Statment', loadCompanyFStatements)">
                                Financial <br>
                            ...
                            <li data-cont=".Financial-Reports"
                                v-on:click="LoadPage('Financial-Reports', loadCompanyFReports)">
                                Financial <br> Reports
                            </li>
                            <li data-cont=".Financial-Ratios"
                                v-on:click="LoadPage('Financial-Ratios', loadCompanyFRatios)">Financial <br> Ratios</li>
                            <li data-cont=".Corporate-Actions"
                                v-on:click="LoadPage('Corporate-Actions', loadCorporateActions)">
                                Corporate <br> Actions
                            </li>
                            <!-- <li data-cont=".Projects" v-on:click="LoadPage('Projects', loadProjects)">Projects</li> -->
                            <li data-cont=".main-Disclosures" v-on:click="openNews('pr__disclosures',0)">
                                Disclosures
                            </li>
                            <li data-cont=".subscription" v-on:click="LoadPage('subscription', loadSubscription)">
                                subscription Centre</li>
                            <li data-cont=".contact-page">Contact IR</li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="content">
                <div class="widgets-container overview" v-cloak v-show="Config.OverView.Visible">
                    <div class="ticker" v-cloak v-show="Config.OverView.Ticker">
                        ...
                        <ul class="ticker-tab">
                            <li class="active" data-cont="1D" v-on:click="fetchCartData('overviewchart','1D')"
                                v-if="!Config.OverView.ExcludeTickerTabs.includes('1D')">1D</li>
                            <li data-cont="5D" v-on:click="fetchCartData('overviewchart','5D')"
                                v-if="!Config.OverView.ExcludeTickerTabs.includes('5D')">5D</li>
                            <li data-cont="3M" v-on:click="fetchCartData('overviewchart','3M')"
                                v-if="!Config.OverView.ExcludeTickerTabs.includes('3M')">3M</li>
                            <li data-cont="6M" v-on:click="fetchCartData('overviewchart','6M')"
                                v-if="!Config.OverView.ExcludeTickerTabs.includes('6M')">6M</li>
                            <li data-cont="1Y" v-on:click="fetchCartData('overviewchart','1Y')"
                                v-if="!Config.OverView.ExcludeTickerTabs.includes('1Y')">1Y</li>
                            <li data-cont="2Y" v-on:click="fetchCartData('overviewchart','2Y')"
                                v-if="!Config.OverView.ExcludeTickerTabs.includes('2Y')">2Y</li>
                            <li data-cont="5Y" v-on:click="fetchCartData('overviewchart','5Y')"
                                v-if="!Config.OverView.ExcludeTickerTabs.includes('5Y')">5Y</li>
                            <li data-cont="AY" v-on:click="fetchCartData('overviewchart','AY')"
                                v-if="!Config.OverView.ExcludeTickerTabs.includes('AY')">All</li>
                        </ul>
                        <div class="ticker-container">
                            <div class="one-day">
                                ...
                                <p style="font-size: 12px; color: #90F49B; text-align: right;">(15 mins delay)</p>
                    ...
                    <div class="marketvalue" v-cloak v-show="Config.OverView.MarketValues.Visible">
                        <div class="marketvalue__container">
                            ...
                            <div class="marketvalue__container__right">
                                ...
                                <p class="marketvalue__container__right__data"
                                  ...
                                  <p class="marketvalue__container__right__data"
                                    ...
                                    <span class="marketvalue__container__right__data__number">
                                        {{toRealNumber.format(MarketValue)}} Million
                                    </span>
                                </p>
                            ...
                            <div class="marketvalue__container__change" v-show="Config.OverView.MarketValues.Change">
                                <p class="marketvalue__container__change__name">Change</p>
                                <p class="marketvalue__container__change__data">
                                    <span class="marketvalue__container__change__data__period">1 Month</span>
                                ...
                                <p class="marketvalue__container__change__data">
                                    <span class="marketvalue__container__change__data__period">3 Months</span>
                                ...
                                <p class="marketvalue__container__change__data">
                                    <span class="marketvalue__container__change__data__period">6 Months</span>
                                 ...
                                 <p class="marketvalue__container__change__data">
                                    <span class="marketvalue__container__change__data__period">12 Months</span>
                                ...
                                <p class="marketvalue__container__change__data">
                                    <span class="marketvalue__container__change__data__period">Year to date</span>
                    ...
                    <div class="calender" v-cloak v-show="Config.OverView.Calendar">
                        <h2 class="calender__title">Calendar</h2>
                        <div class="calender__container"
                            ...
                            <div class="calender__container__date">
                                ...
                                <span>{{new Date(event.occursOn).toLocaleString('en-us', { month: 'short' })}}</span>
                                <br>
                            ...
                            <div class="calender__container__text">
                                ...
                                <p class="calender__container__text__details"
                                    v-html="event.descriptionEn.substring(0,200)+'...'">
                                ...
                                <p class="calender__container__text__companies">
                                    ...
                                    <span class="calender__container__text__companies__last"
                                        v-on:click="openEvent(event.calendarEventID)">Details </span>
                                </p>
                            </div>
                        </div>

                        <div class="calender__more" v-on:click="openEvent(0)">
                            <span>More from Calendar</span>
                            <i class="fas fa-arrow-right"></i>
                        </div>
                    </div>
                    <div class="annual-reports" v-cloak v-show="Config.OverView.AnnualReport">
                        <h2 class="annual-reports__title">Annual Reports</h2>
                        <p class="annual-reports__number">{{CompanyOverview.financialResultPdf.year}} ANNUAL REPORT</p>
                        <div v-show="!Loading.FinancialResultPdf"
                            ...
                            <a v-bind:href="file.fileURLAr" class="annual-reports__download">
                                ...
                                <span>{{file.fiscalPeriod}} Arabic</span>
                            ...
                            <a v-bind:href="file.fileURLEn" class="annual-reports__download">
                                ...
                                <span>{{file.fiscalPeriod}} English</span>
                                <svg xmlns="http://www.w3.org/2000/svg" width="37.471" height="45.5"
                                    viewBox="0 0 37.471 45.5">
                                    <path id="Icon_material-file-download" data-name="Icon material-file-download"
                                        d="M44.971,20.559H34.265V4.5H18.206V20.559H7.5L26.235,39.294ZM7.5,44.647V50H44.971V44.647Z"
                        ...
                        <div v-on:click="LoadPage('Financial-Reports', loadCompanyFReports)"
                            class="annual-reports__more">
                            <span>More Historical Report </span>
                            <i class="fas fa-arrow-right"></i>
                        </div>
                    </div>
                    <div class="Disclosures" v-cloak v-show="Config.OverView.Disclosures">
                        <h2 class="Disclosures__title">Disclosures</h2>
                        <div class="Disclosures__container" v-show="!Loading.CompanyOverview"
                            ...
                            <div class="Disclosures__container__text">
                                ...
                                <p class="Disclosures__container__text__companies">
                                    <span class="Disclosures__container__text__companies__first">
                                        {{Article.articleSourceName}}
                                        {{Article.publishedOn}}
                                    </span>
                                    <span class="Disclosures__container__text__companies__last"
                                        v-on:click="openNews('pr__disclosures',Article.articleID,Article)">Read</span>
                                </p>
                            </div>
                        </div>

                        <div class="Disclosures__more more" v-on:click="openNews('pr__disclosures',0)">
                            <span>Read more Disclosures</span>
                            <i class="fas fa-arrow-right"></i>
                        </div>
                    </div>
                    <div class="financial-ratios" v-cloak v-show="Config.OverView.FinancialRatios">
                        <p class="financial-ratios__title">Financial Ratios</p>
                        <ul class="financial-ratios__list">
                            <li class="financial-ratios__list__item">
                                <span class="financial-ratios__list__item__name">Financial Ratio</span>
                                <span class="financial-ratios__list__item__number">Current</span>
                            </li>
                            <li class="financial-ratios__list__item"
                                v-for="fr in CompanyOverview.financialRatios.fields"
                                v-if="!Config.OverView.ExcludeFromFinancialRatios.includes(fr.nameEn)">
                                <span class="financial-ratios__list__item__name">{{fr.nameEn}}</span>
                        ...
                        <a href="#" v-on:click="LoadPage('Financial-Ratios', loadCompanyFRatios)"
                            class="financial-ratios__more more">
                            <span class="financial-ratios__more__name">More</span>
                            <span class="financial-ratios__more__icon"><i class="fas fa-arrow-right"></i></span>
                        </a>
                    </div>
                    <div class="corporate-actions" v-cloak v-show="Config.OverView.CorporateActions.Visible">
                        <p class="corporate-actions__title">Corporate Actions</p>
                        <ul class="corporate-actions__tabs">
                            ...
                            <li data-cont=".corporate-actions-recent-dividends"
                                ...
                                v-bind:class="CompanyOverview.cpaitalSummary == null? 'active' : ''">
                                Recent Dividends
                            </li>
                        </ul>
                        <div class="corporate-actions__container">
                            <ul class="corporate-actions__list corporate-actions-recent-change"
                                ...
                                <li class="corporate-actions__list__item" v-cloak
                                    ...
                                    <span class="corporate-actions__list__item__name">Previous Capital</span>
                                    <span class="corporate-actions__list__item__number">
                                        {{
                                        formatter.format(CompanyOverview.cpaitalSummary ?
                                        CompanyOverview.cpaitalSummary.currentCapital : 0)
                                        }} <br>
                                        {{
                                        CompanyOverview.cpaitalSummary ?
                                        CompanyOverview.cpaitalSummary.measuringUnitNameEn : ""
                                        }}
                                        {{
                                        CompanyOverview.cpaitalSummary ? CompanyOverview.cpaitalSummary.currencyNameEn
                                        : ""
                                        }}
                                    </span>
                                </li>
                                <li class="corporate-actions__list__item" v-cloak
                                    ...
                                    <span class="corporate-actions__list__item__name">
                                        Previous No. <br> of Shares
                                        (M)
                                    </span>
                                    <span class="corporate-actions__list__item__number">
                                        {{
                                        CompanyOverview.cpaitalSummary
                                        ? CompanyOverview.cpaitalSummary.currentShares : ""
                                        }}
                                    </span>
                                </li>
                                <li class="corporate-actions__list__item" v-cloak
                                    v-show="Config.OverView.CorporateActions.RecentChanges.CapitalChange">
                                    <span class="corporate-actions__list__item__name">Capital Change</span>
                                    <span class="corporate-actions__list__item__number">
                                        {{
                                        ((CompanyOverview.cpaitalSummary
                                ...
                                <li class="corporate-actions__list__item" v-cloak
                                    ...
                                    <span class="corporate-actions__list__item__name">
                                        Current No. of <br> Shares (M)
                                        (M)
                                    </span>
                                    <span class="corporate-actions__list__item__number">
                                        {{
                                        formatter.format(CompanyOverview.cpaitalSummary
                                        ? CompanyOverview.cpaitalSummary.newShares : 0)
                                        }}
                                    </span>
                                </li>
                                <li class="corporate-actions__list__item" v-cloak
                                    v-show="Config.OverView.CorporateActions.RecentChanges.Type">
                                    <span class="corporate-actions__list__item__name">Type</span>
                                    <span class="corporate-actions__list__item__number">
                                        {{
                                        CompanyOverview.cpaitalSummary
                                        ? CompanyOverview.cpaitalSummary.companyCapitalStatusNameEn : ""
                                        }}
                                    </span>
                                </li>
                                <li class="corporate-actions__list__item" v-cloak
                                    v-show="Config.OverView.CorporateActions.RecentChanges.Announcement">
                                    <span class="corporate-actions__list__item__name">Announcement</span>
                                    <span class="corporate-actions__list__item__number">
                                        {{
                                        CompanyOverview.cpaitalSummary
                            ...
                            <ul class="corporate-actions__list corporate-actions-recent-dividends"
                                ...
                                <li class="corporate-actions__list__item" v-cloak
                                    ...
                                    <span class="corporate-actions__list__item__name">Capital (Million SAR)</span>
                                    <span class="corporate-actions__list__item__number">
                                        {{formatter.format(CompanyOverview.dividandInfo.capital)}}
                                    </span>
                                </li>
                                <li class="corporate-actions__list__item" v-cloak
                                    v-show="Config.OverView.CorporateActions.RecentDividends.Shares">
                                    <span class="corporate-actions__list__item__name">Shares (mn)</span>
                                    <span
                                ...
                                <li class="corporate-actions__list__item" v-cloak
                                    ...
                                    <span class="corporate-actions__list__item__name">Dividends/Capital (%)</span>
                                    <span class="corporate-actions__list__item__number">
                                        {{formatter.format(CompanyOverview.dividandInfo.dividendPercentage)}}
                                        %
                                    </span>
                                </li>
                                <li class="corporate-actions__list__item" v-cloak
                                    v-show="Config.OverView.CorporateActions.RecentDividends.CashDividend">
                                    <span class="corporate-actions__list__item__name">Cash Dividend</span>
                                    <span class="corporate-actions__list__item__number">
                                        {{formatter.format(CompanyOverview.dividandInfo.cashDividend)}}
                                        {{CompanyOverview.dividandInfo.measuringUnitNameEn}}
                                        {{CompanyOverview.dividandInfo.currencyNameEn}}
                                    </span>
                                </li>
                                <li class="corporate-actions__list__item" v-cloak
                                    v-show="Config.OverView.CorporateActions.RecentDividends.DividendPolicy">
                                    <span class="corporate-actions__list__item__name">Dividend Policy</span>
                                    <span
                                ...
                                <li class="corporate-actions__list__item" v-cloak
                                    ...
                                    <span class="corporate-actions__list__item__name">Type</span>
                                    <span
                                        class="corporate-actions__list__item__number">{{CompanyOverview.dividandInfo.companyDividendStatusNameEn}}</span>
                                </li>
                                <li class="corporate-actions__list__item" v-cloak
                                    ...
                                    <span class="corporate-actions__list__item__number">
                                        {{
                                        new
                                        Date(CompanyOverview.dividandInfo.dividendAnnouncedDate).toLocaleString('en-us')
                                        }}
                                    </span>
                                </li>
                            </ul>
                        ...
                        <a href="#" v-on:click="LoadPage('Corporate-Actions', loadCorporateActions)"
                            class="corporate-actions__more more">
                            <span class="corporate-actions__more__name">More</span>
                            <span class="corporate-actions__more__icon"><i class="fas fa-arrow-right"></i></span>
                        </a>
                    </div>
                        ...
                        <div class="latest-news__container"
                            ...
                            <div class="latest-news__container__text">
                                ...
                                <p class="latest-news__container__text__companies">
                                    <span class="latest-news__container__text__companies__first">
                                        {{Article.articleSourceName}}
                                        {{Article.publishedOn}}
                                    </span>
                                    <span class="latest-news__container__text__companies__last"
                                        v-on:click="openNews('pr__latestnews',Article.articleID,Article)">Read</span>
                                </p>
                            </div>
                        </div>
                    ...
                    <div class="analyst-estimates" v-cloak v-show="Config.OverView.AnalystEstimates">
                        <h2 class="analyst-estimates__title">Analyst Estimates</h2>
                            ...
                            <div class="analyst-estimates__container__text">
                                ...
                                <p class="analyst-estimates__container__text__companies">
                                    ...
                                    <span class="analyst-estimates__container__text__companies__last"
                                        v-on:click="openNews('pr__analyst_estimates',Article.articleID, Article)">Read</span>
                                </p>
                            </div>
                        </div>
                        <div class="analyst-estimates__more more" v-on:click="openNews('pr__analyst_estimates',0)">
                            <span>Read more Estimates</span>
                            <i class="fas fa-arrow-right"></i>
                        </div>
                    </div>
                    <div class="contact-ir" v-cloak v-show="Config.OverView.Contact.Visible">
                        <p class="contact-ir__title">Contact IR</p>
                        <p class="contact-ir__address" v-cloak v-show="Config.OverView.Contact.Address">
                        ...
                        <ul class="contact-ir__address-details" v-cloak v-show="Config.OverView.Contact.Address">
                            <li class="contact-ir__address-details__item">
                                {{CompanyOverview.profileInfo.addressEn}}
                            </li>
                            <li class="contact-ir__address-details__item">
                                P.O.Box {{CompanyOverview.profileInfo.poBoxEn}}
                            </li>
                        </ul>
                        <ul class="contact-ir__contact">
                            <li class="contact-ir__contact__item">
                                ...
                                <span>
                                    966 11 4000 612 <span style="margin-left: 10px;">Ext: 222</span>
                                </span>
                            </li>
                            <li class="contact-ir__contact__item">
                        ...
                        <div class="contact-ir__download" v-cloak v-show="Config.OverView.Contact.DwonloadApp.Visible">
                            <span class="contact-ir__download__link">Download IR App</span>
                ...
                <div class="widgets-container profile" v-cloak v-show="Config.Profile.Visible">
                    <div class="intro">
                        <div class="intro__container" v-cloak v-show="Config.Profile.Business">
                            ...
                            <p class="intro__container__text" v-html="CompanyProfile.profileInfo.overviewEn">
                            </p>
                        </div>
                        <div class="intro__container" v-cloak v-show="Config.Profile.Overview">
                            ...
                            <p class="intro__container__text">
                                In accordance with the main and subsidiary Commercial Registrations, the Company
                                activities consist of the following: Extension and maintenance of water lines between
                                and within cities and construction of new networks, construction and repair of stations
                                and main lines of water distribution, construction and repair of irrigation and watering
                                canals, main water storage towers, drilling water wells, construction and repair of
                                sewage stations and projects, and sewage networks and pumps, and construction of dams.
                                Repair and maintenance of water pipes, pipelines, and water purification devices, and
                                collection and purification of water, disposal of sewage, operation of networks and
                                sewage treatment facilities, extension, maintenance and repair of oil and gas pipelines,
                                drilling of water wells and extension of irrigation pipes, and management of
                                construction projects. Retail sale of electrical equipment and supplies, sale of
                                measurement and control devices, navigation equipment and devices, sale of water pumping
                                equipment, retail sale of water purification equipment and supplies, and retail sale of
                                electrical generators and supplies. Water transmission and distribution, construction
                                and repair of roads and streets, sidewalks and road supplies, construction of electric
                                power stations and converters, construction of port berths and marine constructions,
                                cleaning of waterways, groundwater withdrawal and site drying, installation, maintenance
                                and repair of solar energy networks, and energy efficiency project management
                                activities.
                            </p>
                        </div>
                    </div>
                    <!--<div class="Financials-Highlights" v-cloak v-show="Config.Profile.FinancialsHighlights" v-if="CompanyProfile.financialHighlights != null">
                        <div class="Financials-Highlights__currency">
                            <p class="Financials-Highlights__title">
                                Financials Highlights <span class="Financials-Highlights__currency__type-en">
                                    (M
                                    SAR)
                                </span>
                            </p>
                            <ul class="Financials-Highlights-tabs" v-cloak v-show="Config.Profile.CurrencyConversion">
                                <li data-cont="Financials_Highlights__usd"
                                    ...
                                    class="Financials-Highlights-tabs__usd-en">USD</li>
                                <li data-cont="Financials_Highlights__riyal"
                                    v-on:click="setCurrencyFinancialHighlight('RIYAL')"
                                    class="active Financials-Highlights-tabs__riyal-en">SAR</li>
                            </ul>
                        </div>
                            ...
                            <div class="stock-information__riyal riyal">
                                <ul class="stock-information__list">
                                    <li class="stock-information__list__item" v-cloak
                                        ...
                                        <span class="stock-information__list__item__name">Shares Outstanding (M)</span>
                                    ...
                                    <li class="stock-information__list__item" v-cloak
                                        ...
                                        <span class="stock-information__list__item__name">Par Value (SAR)</span>
                                        <span class="stock-information__list__item__number">
                                    ...
                                    <li class="stock-information__list__item" v-cloak
                                        ...
                                        <span class="stock-information__list__item__name">Book Value (SAR)</span>
                                        <span class="stock-information__list__item__number">
                                    ...
                                    <li class="stock-information__list__item" v-cloak
                                        ...
                                        <span class="stock-information__list__item__name">Market Cap (M)</span>
                                        <span class="stock-information__list__item__number">
                                ...
                                <a href="#" v-on:click="LoadPage('Financial-Ratios', loadCompanyFRatios)"
                                    ...
                                    <span class="stock-information__more__name">More</span>
                    ...
                    <div class="trading-data" v-cloak v-show="Config.Profile.TradingData.Visible">
                        ...
                        <ul class="trading-data__list">
                            ...
                            <li class="trading-data__list__item" v-cloak v-show="Config.Profile.TradingData.FreeFloat">
                                <span class="trading-data__list__item__name">Free Float (M):</span>
                                <span class="trading-data__list__item__number">
                            ...
                            <li class="trading-data__list__item" v-cloak
                                ...
                                <span class="trading-data__list__item__name">Free Float %:</span>
                                <span class="trading-data__list__item__number">
                            ...
                            <li class="trading-data__list__item" v-cloak
                                ...
                                <span class="trading-data__list__item__name">Weight in Index % :</span>
                                <span class="trading-data__list__item__number">
                            ...
                            <li class="trading-data__list__item" v-cloak
                                ...
                                <span class="trading-data__list__item__name">3M Average Volume :</span>
                                <span class="trading-data__list__item__number">
                            ...
                            <li class="trading-data__list__item" v-cloak
                                ...
                                <span class="trading-data__list__item__name">3M Average Transactions :</span>
                                <span class="trading-data__list__item__number">
                    ...
                    <div class="Major-Shareholders" v-cloak v-show="Config.Profile.MajorShareholders.Visible">
                        <p class="Major-Shareholders__title">Major Shareholders</p>
                        ...
                        <a href="#" v-on:click="LoadPage('Major-Shareholder', loadMajorShareholders)"
                            ...
                            <span class="Major-Shareholders__more__name">More</span>
                            <span class="Major-Shareholders__more__icon"><i class="fas fa-arrow-right"></i></span>
                        </a>
                    </div>
                    <div class="milestones" v-cloak v-show="Config.Profile.Milestones">
                        <p class="milestones__title">Milestones</p>
                ...
                <div class="widgets-container Chart">
                    <div class="main-chart">
                        ...
                        <h2 class="main-chart__company-name">{{CompanyOverview.profileInfo.companyNameEn}}</h2>
                            ...
                            <div class="chart-financials-highlights__riyal">
                                <div class="chart-financials-highlights__data">
                                    ...
                                    <div class="chart-financials-highlights__data__date">
                                        <p class="chart-financials-highlights__data__date__day">Date</p>
                ...
                <div class="widgets-container Organisational-Structure">
                    <div class="structure">
                        <ul class="structure__tabs">
                            <li data-cont=".structure__executives" class="active">Executives</li>
                            <li data-cont=".structure__board">Board of Directors</li>
                        </ul>
                            ...
                            <div class="structure__executives">
                                <div class="structure__executives__member structure__executives__member-one"
                                    ...
                                    <p class="structure__executives__member__title">
                                        <span v-on:click="showIndividualDetails(Individual.individualID)">
                                            {{Individual.positionNameEn}} <i class="fas fa-chevron-right"></i>
                                        </span>
                                    </p>
                                </div>
                            </div>
                        ...
                        <div class="structure__member-details structure__board__member-details-one"
                            ...
                            <p class="structure__member-details__meta">
                                <svg xmlns="http://www.w3.org/2000/svg" width="31.746" height="35.979"
                                    ...
                                    <path id="Icon_material-subdirectory-arrow-right"
                                        ...
                                        d="M37.746,29.28l-12.7,12.7-3.005-3.005,7.6-7.577H6V6h4.233V27.164H29.64l-7.6-7.577,3.005-3.005Z"
                                        transform="translate(-6 -6)" />
                                </svg>
                                <span class="structure__member-details__meta__category">
                                    {{Individual.companyPositionTypeID == 1 ?'Board & Management':'Executives'}}
                                </span>
                                <span class="structure__member-details__meta__slash">
                                    /
                                </span>
                                <span class="structure__member-details__meta__name">
                                    {{Individual.positionNameEn}} - {{Individual.nameEn}}
                                </span>
                            </p>
                            <div class="structure__member-details__profile">
                                <div class="structure__member-details__profile__img">
                                    <img v-bind:src="toAvatar(Individual.profilePicURL)" v-bind:alt="Individual.nameEn">
                                </div>
                            ...
                            <div class="structure__member-details__about" v-html="Individual.resumeHighLightEn">
                            </div>
                        ...
                        <div class="main-major-shareholders__container">
                            <div class="main-major-shareholders__container__major-shareholders">
                                <div class="main-major-shareholders__container__major-shareholders__data">
                                    ...
                                    <div class="main-major-shareholders__container__major-shareholders__data__details">
                                        <table class="main-major-shareholders__container__major-shareholders__data__details__table">
                                            <tr class="main-major-shareholders__container__major-shareholders__data__details__table__row">
                                                <th class="main-major-shareholders__container__major-shareholders__data__details__table__row__head">
                                                    <p class="main-major-shareholders__container__major-shareholders__data__details__table__row__head__text">
                                                        Type
                                                    </p>
                                                </th>
                                                <th class="main-major-shareholders__container__major-shareholders__data__details__table__row__head">
                                            ...
                                            <tr class="main-major-shareholders__container__major-shareholders__data__details__table__row"
                                                v-for="Shareholder in MajorShareholders.shareholders">
                                                <td class="main-major-shareholders__container__major-shareholders__data__details__table__row__data">
                                                    <p class="main-major-shareholders__container__major-shareholders__data__details__table__row__data__text">
                            ...
                            <div class="main-major-shareholders__container__historical-changes">
                                <div class="main-major-shareholders__container__historical-changes__data">
                                    ...
                                    <div class="main-major-shareholders__container__historical-changes__data__shareholders">
                                        <p class="main-major-shareholders__container__historical-changes__data__shareholders__name">
                                            Date
                                        </p>
                                        <p class="main-major-shareholders__container__historical-changes__data__shareholders__name">
                                            07/03/2021
                                    ...
                                    <div class="main-major-shareholders__container__historical-changes__data__details">
                                        <table class="main-major-shareholders__container__historical-changes__data__details__table">
                                            <tr class="main-major-shareholders__container__historical-changes__data__details__table__row">
                                                <th class="main-major-shareholders__container__historical-changes__data__details__table__row__head">
                                                    <p class="main-major-shareholders__container__historical-changes__data__details__table__row__head__text">
                                                        Shareholder
                                                    </p>
                                                </th>
                                                <th class="main-major-shareholders__container__historical-changes__data__details__table__row__head">
                                            ...
                                            <tr class="main-major-shareholders__container__historical-changes__data__details__table__row">
                                                <td class="main-major-shareholders__container__historical-changes__data__details__table__row__data">
                                                    <p class="main-major-shareholders__container__historical-changes__data__details__table__row__data__text">
                                                        Namaa Alkhorayef co.
                                                    </p>
                                                </td>
                                                <td class="main-major-shareholders__container__historical-changes__data__details__table__row__data">
                                    ...
                                    <table class="main-major-shareholders__container__board__data__table">
                                        <tr class="main-major-shareholders__container__board__data__table__row">
                                            <td
                                                ...
                                                <table
                                                    class="main-major-shareholders__container__board__data__table__row__data__table">
                                                    <tr>
                                        ...
                                        <tr class="main-major-shareholders__container__board__data__table__row" v-for="member in BoardOfDirectors">
                                            <td
                                                ...
                                                <table
                                                    ...
                                                    <tr>
                                                        <!--<td class="num">1</td>-->
                                                        <td class="name"> {{member.nameEn}} </td>
                                                    </tr>
                                                </table>
                                            </td>
                ...
                <div class="widgets-container Financial-Statment">
                    <div class="main-financial-statement">
                        <p class="main-financial-statement__title"> Financial Statements </p>
                        <div class="main-financial-statement__head">
                            <ul class="main-financial-statement__head__tabs">
                                <li data-cont=".st-annual" class="active"
                                    @click="fetchCompanyFStatementsForPeriod('year')">Annual</li>
                                <li data-cont=".st-quarter" @click="fetchCompanyFStatementsForPeriod('quarter')">
                                    Quarter
                                </li>
                                <!--<li data-cont=".st-interim" @click="fetchCompanyFStatementsForPeriod('interim')">
                                    Interim
                                </li>-->
                            </ul>
                            <div class="main-financial-statement__head__options">
                                ...
                                <ul class="main-financial-statement__head__options__tabs">
                                    <li data-cont="main-financial-statement__usd"
                                        ...
                                        class="main-financial-statement__head__options__tabs__usd main-financial-statement__head__options__tabs__usd-en">
                                        USD
                                    </li>
                                    <li data-cont="main-financial-statement__sar"
                                        v-on:click="setCurrencyFinancialStatement('SAR')"
                                        class="active main-financial-statement__head__options__tabs__riyal main-financial-statement__head__options__tabs__riyal-en">
                                        SAR
                                    </li>
                                </ul>
                                ...
                                <a href="https://www.argaam.com/en/excel/financial-statment/13068?marketid=3&fromyear=2018&toyear=2021&yearly=true&quarterly=true&interm=false&currencyID=3"
                                    class="main-financial-statement__head__options__link">
                                            ...
                                            <table id="companyFinancialResult" class="table clear" width="100%"
                                                ...
                                                <tbody>
                                                    <tr class="group1 argaam-font" style="border-top: 1px solid white;">
                                                        <th class="argaam-font col_sticky col_bg">Details </th>
                                                        <th style="min-width:40px; max-width:40px;">
                                                        </th>
                                                        <th class="center" style="background-color:#1a516d ;"
                                                            v-for="value in CompanyFStatements.tabs[0].fields[0].values">
                                                            Million <span class="st-currency st-currency-en">SAR</span>
                                                        </th>
                                                    </tr>
                                                    <tr class="dummy">
                                                        <th colspan="100"></th>
                                                    ...
                                                    <template v-show="CompanyFStatements.tabs[0].fields[0].values"
                                                        ...
                                                        <tr class="level2 level2tds" v-for="field in tab.fields"
                                                            ...
                                                            <td v-for="val in field.values"
                                                                ...
                                                                <span>
                                                                    {{fomratedValue(val, field.displayNameEn)}}
                                                                </span>
                                                            </td>
                                                        </tr>
                                                    </template>
                ...
                <div class="widgets-container Financial-Ratios">
                    <div class="main-financial-ratio">
                        <p class="main-financial-ratio__title"> Financial Ratios </p>
                        <div class="main-financial-ratio__head">
                            <ul class="main-financial-ratio__head__tabs">
                                ...
                                <li data-cont=".ra-trailing" @click="fetchCompanyFRatiosForPeriod('quarter')">
                                    Trailing
                                    12 Month <span>(TTM) </span>
                                </li>
                                <!--<li data-cont=".ra-annualized" @click="fetchCompanyFRatiosForPeriod('interim')">
                                    Annualized
                                </li>-->
                            </ul>
                            <div class="main-financial-ratio__head__options">
                                ...
                                <ul class="main-financial-ratio__head__options__tabs">
                                    <li data-cont="main-financial-ratio__usd"
                                        ...
                                        class="main-financial-ratio__head__options__tabs__usd main-financial-ratio__head__options__tabs__usd-en">
                                        USD
                                    </li>
                                    <li data-cont="main-financial-ratio__sar"
                                        v-on:click="setCurrencyFinancialRatios('SAR')"
                                        class="active main-financial-ratio__head__options__tabs__riyal main-financial-ratio__head__options__tabs__riyal-en">
                                        SAR
                                    </li>
                                </ul>
                                            ...
                                            <table id="companyFinancialResult" class="table clear" width="100%"
                                                ...
                                                <tbody>
                                                    <tr class="group1 argaam-font" style="border-top: 1px solid white;">
                                                        ...
                                                        <th class="center" style="background-color:#1a516d ;"
                                                            v-for="value in CompanyFRatios.financialRatioFieldsGroups[0].financialRatioFieldsGroupFields[0].values">
                                                            Million <span class="ra-currency ra-currency-en">SAR</span>
                                                        </th>
                                                    </tr>
                                                    <tr class="dummy">
                                                        <th colspan="100"></th>
                                                    ...
                                                    <template
                                                        ...
                                                        <tr class="level2 level2tds"
                                                            ...
                                                            <td class="columchart fr-chart-btn"
                                                            ...
                                                            <td v-for="val in field.values"
                                                                v-bind:class="'colum ' + _indx + ' ' + cssClassForValue(val)">
                                                                <span>
                                                                    {{fomratedValue(val, field.nameEn)}}
                                                                </span>
                                                            </td>
                                                        </tr>
                                                    </template>
                                                ...
                                                <tbody>
                                                    ...
                                                    <template
                                                        ...
                                                        <tr class="level2 level2tds"
                                                            ...
                                                            <td class="columchart">
                                                                <span class="chart-btn fr-chart-btn"
                                                                    v-on:click="showChartForFinancialRatio(field)">
                                                                    <svg class="" xmlns="http://www.w3.org/2000/svg"
                                                                        width="20" height="20" viewBox="0 0 56 56">
                                                                        <path id="Icon_material-insert-chart"
                ...
                <div class="widgets-container Corporate-Actions">
                    <div class="capital-change">
                        <p class="capital-change__title">Capital Changes</p>
                        <div id="capital_change_chart" style="width:100%; height:360px;"></div>
                    </div>
                    <div class="recent-change">
                        <p class="recent-change__title">Recent Dividends</p>
                        <ul class="recent-change__list">
                            <li class="recent-change__list__item">
                                <span class="recent-change__list__item__name">Capital (Million SAR)</span>
                                <span
                                    class="recent-change__list__item__number">{{CorporateActions.recentDividends.fundSize}}</span>
                            </li>
                            <li class="recent-change__list__item">
                                <span class="recent-change__list__item__name">Shares (mn)</span>
                                <span
                                    class="recent-change__list__item__number">{{CorporateActions.recentDividends.numberOfShares}}</span>
                            </li>
                            <li class="recent-change__list__item">
                                <span class="recent-change__list__item__name">Dividends/Capital (%)</span>
                                <span class="recent-change__list__item__number">
                                    {{CorporateActions.recentDividends.dividendPercentage}}
                                    %
                                </span>
                            </li>
                            <li class="recent-change__list__item">
                                <span class="recent-change__list__item__name">Cash Dividend</span>
                                <span
                                    class="recent-change__list__item__number">{{CorporateActions.recentDividends.cashDividend}}</span>
                            </li>
                            <li class="recent-change__list__item">
                                <span class="recent-change__list__item__name">Type</span>
                                <span
                                    class="recent-change__list__item__number">{{CorporateActions.recentDividends.companyDividendStatusNameEn}}</span>
                            </li>
                            <li class="recent-change__list__item">
                                <span class="recent-change__list__item__name">Announcement</span>
                                <span class="recent-change__list__item__number">
                                    {{
                                    new
                                    Date(CorporateActions.recentDividends.dividendAnnouncedDate).toLocaleDateString('en-US')
                                    }}
                                </span>
                            </li>
                            <li class="recent-change__list__item">
                                <span class="recent-change__list__item__name">Due Date</span>
                                <span class="recent-change__list__item__number">
                                    {{
                                    new
                                    Date(CorporateActions.recentDividends.dividendDueDate).toLocaleDateString('en-US')
                                    }}
                                </span>
                            </li>
                            <li class="recent-change__list__item">
                                <span class="recent-change__list__item__name">Payment</span>
                                <span class="recent-change__list__item__number">
                                    {{
                                    new
                                    Date(CorporateActions.recentDividends.dividendDate).toLocaleDateString('en-US')
                                    }}
                                </span>
                            </li>
                            <li class="recent-change__list__item">
                                <span class="recent-change__list__item__name">Notes</span>
                                <span
                                    class="recent-change__list__item__number">{{CorporateActions.recentDividends.notesEn}}</span>
                            </li>
                        </ul>
                    </div>
                    <div class="historical-dividends">
                        <p class="historical-dividends__title">Historical Dividends</p>
                    ...
                    <div class="main-corporate-actions">
                        <ul class="main-corporate-actions__tabs">
                            <li data-cont=".main-corporate-actions__capital-changes" class="active">Capital Changes</li>
                            <li data-cont=".main-corporate-actions__dividend-history">Dividend History</li>
                        </ul>
                            ...
                            <div class="main-corporate-actions__capital-changes">
                                <table class="main-corporate-actions__capital-changes__table">
                                    ...
                                    <tr class="main-corporate-actions__capital-changes__table__row"
                                        ...
                                        <td class="main-corporate-actions__capital-changes__table__row__data">
                                            <a v-show="capitalChange_history.linkEn"
                                                v-bind:href="'capitalChange_history.linkEn'"
                ...
                <div class="widgets-container main-Disclosures">
                    <div class="pr" id="pr">
                        ...
                        <div class="pr-scroll-tabs">
                            <ul class="pr__tabs">
                                <!--<li class="active" data-cont=".pr__press-release">Press Release</li>-->

                                <li data-cont=".pr__disclosures">Disclosures</li>
                                <li data-cont=".pr__calendar">Calendar</li>
                                <li data-cont=".pr__latestnews">Latest News</li>
                                <li data-cont=".pr__analyst_estimates">Analyst Estimates</li>
                            </ul>
                        </div>
                                ...
                                <div class="pr__calendar-modal" v-for="event in CompanyOverview.events"
                                    ...
                                    <div class="modal-wrapper modal-transition">
                                        <div class="modal-header">
                                            <h2 class="modal-heading">Calendar</h2>
                                        ...
                                        <div class="modal-body">
                                            <p class="modal-body__row">
                                                <span class="modal-body__row__name">Market</span>
                                                <span class="modal-body__row__value">TASI</span>
                                            </p>
                                            <p class="modal-body__row">
                                                <span class="modal-body__row__name">Company</span>
                                                <span class="modal-body__row__value">AWPT</span>
                                            </p>
                                            <p class="modal-body__row">
                                                <span class="modal-body__row__name">Title</span>
                                                <span class="modal-body__row__value"> {{event.titleEn}}</span>
                                            </p>
                                            <p class="modal-body__row">
                                                <span class="modal-body__row__name">Date</span>
                                                <span class="modal-body__row__value">
                                                    {{
                                                    new
                                                    Date(event.occursOn).toLocaleDateString('en-US')
                                                    }}
                                                </span>
                                            </p>
                                            <p class="modal-body__row">
                                                <span class="modal-body__row__name">Calendar Event Type</span>
                                                <span class="modal-body__row__value"
                                                    v-html="event.descriptionEn"></span>
                                            </p>

                                            <p class="modal-body__row">
                                                <span class="modal-body__row__name">Venue</span>
                                                <span class="modal-body__row__value">{{event.eventLocationEn}}</span>
                                            </p>
                ...
                <div class="widgets-container subscription">
                    <div class="subscription-center">
                        <p class="subscription-center--text">Select from the options below to receive news and financial
                        ...
                        <form class="subscription-center__form">
                            <div class="subscription-center__form__custom-checkbox">
                                <template v-for="alert in Alerts">
                                    <input type="checkbox" class="subscription-center__form__custom-checkbox__input"
                                        v-bind:data-cont="alert.alertTypeID" v-bind:id="'cbx__'+ alert.alertTypeID" />
                                    <label class="subscription-center__form__custom-checkbox__label"
                                        v-bind:for="'cbx__'+ alert.alertTypeID">{{alert.typeNameEn}}</label>
                                </template>
                            </div>
                            <div class="subscription-center__inputs__container">
                                <input v-model="AlertSubscriber.email" @change="checkEmailExists"
                                    class="subscription-center__inputs__container--data" autocomplete="off" type="text"
                                    id="email-input" name="inputMail" placeholder="Email" />
                                <input v-model="AlertSubscriber.firstName"
                                    class="subscription-center__inputs__container--data" autocomplete="off" type="text"
                                    id="first-name-input" name="firstName" placeholder="First Name" />
                                <input v-model="AlertSubscriber.lastName"
                                    class="subscription-center__inputs__container--data" autocomplete="off" type="text"
                                    id="last-name-input" name="lastName" placeholder="Last Name" />
                                <input v-model="AlertSubscriber.jobTitle"
                                    class="subscription-center__inputs__container--data" autocomplete="off" type="text"
                                    id="company-input" name="company" placeholder="Company" />
                                <div class="subscription-center__custom--country">
                                    <select v-model="AlertSubscriber.countryName"
                                        class="subscription-center__custom--country__select">
                                ...
                                <input v-show="AlertSubscriber.showCode" v-model="AlertSubscriber.updateCode"
                                    class="subscription-center__inputs__container--data" autocomplete="off" type="text"
                                    id="company-input" name="company" placeholder="Confirmation Code" />
                            </div>
                            ...
                            <a href="#" v-show="!AlertSubscriber.showCode" v-on:click="subscribe"
                                class="subscription-center__subscribe-btn">Subscribe</a>
                            <a href="#" v-show="AlertSubscriber.showCode" v-on:click="subscribe"
                                class="subscription-center__subscribe-btn">Update Subscription</a>

                            <p class="subscription-center__subscribe-link" v-show="AlertSubscriber.showCode">
                                You already subscribe for Alerts, please enter the confirmation code send to your
                                emails, if you don't have the confirmation code click
                                <a href="#" v-on:click="resendConformationCode">here</a> to rceive it.
                            </p>
                        </form>
                    </div>
                </div>
                <div class="widgets-container contact-page">
                    <div class="contact" v-cloak v-show="Config.OverView.Contact.Visible">
                        <p class="contact__title">Contact IR</p>
                        <p class="contact__address" v-cloak v-show="Config.OverView.Contact.Address">
                            <i class="fas fa-map-marker-alt"></i><span>Address</span>
                        </p>
                        ...
                        <div class="contact__download" v-cloak v-show="Config.OverView.Contact.DwonloadApp.Visible">
                            <span class="contact__download__link">Download IR App</span>
        ...
        <div class="footer noprint">
            <div class="footer__row">
                <div class="footer__row__notice">
                    © Copyright
                    <script>document.write(new Date().getFullYear());</script> AWPT - All Right Reserved
                </div>
    ...
    <script src="js/app-config.js?v=73837"></script>
    <script src="js/alkhorayefapp.js?v=73838"></script>
    <script src="js/main.js?v=73837"></script>
